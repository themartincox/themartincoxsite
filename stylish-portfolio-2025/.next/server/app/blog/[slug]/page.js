(()=>{var e={};e.id=953,e.ids=[953],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},1625:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>m});var s=i(1125),n=i(1121),a=i(4493),r=i(9523),o=i(5773),l=i(5814),c=i.n(l),u=i(3210);let d={"trans-america-racing-to-building-businesses":{id:1,title:"From Trans America Racing to Building Businesses: How Cycling Shaped My Entrepreneurial Journey",slug:"trans-america-racing-to-building-businesses",excerpt:"The mental resilience, strategic thinking, and endurance mindset developed through ultra-distance cycling became the foundation for building three successful businesses.",category:"Entrepreneurship",readTime:"8 min read",date:"2025-01-15",image:"\uD83D\uDEB4",featured:!0,author:"Martin Cox",content:`
...
*The start line and the board room have more in common than you might think.*
    `,tags:["Entrepreneurship","Cycling","Strategy","ADHD","Resilience"],relatedPosts:["adhd-entrepreneurial-advantage","ultra-distance-cycling-lessons","growing-smes-marketing"]},"adhd-entrepreneurial-advantage":{id:2,title:"The ADHD Advantage: Why Neurodiversity is Your Entrepreneurial Superpower",slug:"adhd-entrepreneurial-advantage",excerpt:"Discover how ADHD traits like hyperfocus, pattern recognition, and creative problem-solving can become massive advantages in business.",category:"ADHD",readTime:"6 min read",date:"2025-01-10",image:"\uD83E\uDDE0",author:"Martin Cox",content:`
...
*Ready to turn your neurodiversity into your competitive advantage?*
    `,tags:["ADHD","Entrepreneurship","Neurodiversity","Business Strategy","Personal Development"],relatedPosts:["trans-america-racing-to-building-businesses","late-adhd-diagnosis","hyperfocus-productivity"]},"milk-bottle-tops-nostalgic-business":{id:3,title:"Building Milk Bottle Tops: Turning Nostalgia into a Sustainable Business",slug:"milk-bottle-tops-nostalgic-business",excerpt:"The story behind reviving a nostalgic product and creating a business that spans decades, from idea to implementation.",category:"Business Case Study",readTime:"5 min read",date:"2025-01-05",image:"\uD83E\uDD5B",author:"Martin Cox",content:`
...
*Sometimes the most sustainable businesses are built on the simplest human truths: we all want to feel connected to something meaningful.*
    `,tags:["Business Case Study","Nostalgia Marketing","Product Development","Cultural Preservation","Sustainability"],relatedPosts:["trans-america-racing-to-building-businesses","adhd-entrepreneurial-advantage","glazing-supplies-scaling"]}};function m({params:e}){let{slug:t}=(0,u.use)(e),i=d[t];return i||(0,o.notFound)(),(0,s.jsxs)("main",{className:"min-h-screen pt-24",children:[(0,s.jsx)("section",{className:"section-padding",children:(0,s.jsx)("div",{className:"container",children:(0,s.jsxs)(n.P.div,{initial:{opacity:0,y:40},animate:{opacity:1,y:0},transition:{duration:.8},className:"max-w-4xl mx-auto",children:[(0,s.jsxs)(n.P.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.1},className:"flex items-center gap-2 text-sm text-muted-foreground mb-8",children:[(0,s.jsx)(c(),{href:"/blog",className:"hover:text-accent transition-colors",children:"Blog"}),(0,s.jsx)("span",{children:"→"}),(0,s.jsx)("span",{children:i.category}),(0,s.jsx)("span",{children:"→"}),(0,s.jsx)("span",{className:"text-foreground",children:i.title})]}),(0,s.jsxs)(n.P.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.2},className:"text-center mb-12",children:[(0,s.jsx)("div",{className:"text-6xl mb-6",children:i.image}),(0,s.jsxs)("div",{className:"inline-flex items-center gap-4 text-sm text-muted-foreground mb-6",children:[(0,s.jsx)("span",{className:`px-3 py-1 rounded-full ${"ADHD"===i.category?"bg-creative text-creative-foreground":"Entrepreneurship"===i.category?"bg-secondary text-secondary-foreground":"Business Case Study"===i.category?"bg-accent text-accent-foreground":"bg-success text-success-foreground"}`,children:i.category}),(0,s.jsx)("span",{children:i.readTime}),(0,s.jsx)("span",{children:new Date(i.date).toLocaleDateString()}),(0,s.jsxs)("span",{children:["By ",i.author]})]}),(0,s.jsx)("h1",{className:"text-4xl md:text-5xl font-display font-bold mb-6 text-balance",children:i.title}),(0,s.jsx)("p",{className:"text-xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed",children:i.excerpt})]})]})})}),(0,s.jsx)("section",{className:"section-padding",children:(0,s.jsx)("div",{className:"container",children:(0,s.jsx)(n.P.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.3},className:"max-w-4xl mx-auto prose prose-lg prose-slate dark:prose-invert",children:(0,s.jsx)("div",{className:"blog-content",children:i.content.split("\n").map((e,t)=>{if(""===e.trim())return null;let i=`${e.substring(0,20).replace(/\s+/g,"-")}-${t}`;return e.startsWith("# ")?(0,s.jsx)("h1",{className:"text-4xl md:text-5xl font-display font-bold mb-8 text-balance",children:e.replace("# ","")},i):e.startsWith("## ")?(0,s.jsx)("h2",{className:"text-2xl md:text-3xl font-display font-semibold mb-6 mt-12 text-balance",children:e.replace("## ","")},i):e.startsWith("### ")?(0,s.jsx)("h3",{className:"text-xl font-display font-semibold mb-4 mt-8",children:e.replace("### ","")},i):e.startsWith("**")&&e.endsWith("**")?(0,s.jsx)("p",{className:"font-semibold text-lg mb-4",children:e.replace(/\*\*/g,"")},i):e.startsWith("*")&&e.endsWith("*")?(0,s.jsx)("p",{className:"italic text-muted-foreground text-center mb-6 text-lg",children:e.replace(/\*/g,"")},i):e.startsWith("- ")?(0,s.jsx)("li",{className:"text-muted-foreground leading-relaxed mb-2 ml-4",children:e.replace("- ","")},i):(0,s.jsx)("p",{className:"text-muted-foreground leading-relaxed mb-6",children:e},i)}).filter(Boolean)})})})}),(0,s.jsx)("section",{className:"section-padding bg-muted/30",children:(0,s.jsx)("div",{className:"container",children:(0,s.jsxs)(n.P.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},viewport:{once:!0},className:"max-w-4xl mx-auto",children:[(0,s.jsx)("h3",{className:"text-xl font-semibold mb-6",children:"Tags"}),(0,s.jsx)("div",{className:"flex flex-wrap gap-3 mb-12",children:i.tags.map(e=>(0,s.jsx)("span",{className:"px-4 py-2 rounded-full text-sm bg-background border border-border hover:border-accent transition-colors cursor-pointer",children:e},e))}),(0,s.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-between items-center pt-8 border-t border-border",children:[(0,s.jsx)(r.$,{variant:"outline",asChild:!0,children:(0,s.jsx)(c(),{href:"/blog",children:"← Back to Blog"})}),(0,s.jsxs)("div",{className:"flex gap-4",children:[(0,s.jsx)(r.$,{variant:"outline",size:"sm",children:"Share on LinkedIn"}),(0,s.jsx)(r.$,{variant:"outline",size:"sm",children:"Share on Twitter"})]})]})]})})}),i.relatedPosts&&i.relatedPosts.length>0&&(0,s.jsx)("section",{className:"section-padding",children:(0,s.jsx)("div",{className:"container",children:(0,s.jsxs)(n.P.div,{initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},transition:{duration:.8},viewport:{once:!0},className:"max-w-6xl mx-auto",children:[(0,s.jsx)("h2",{className:"text-3xl font-display font-semibold mb-12 text-center",children:"Related Articles"}),(0,s.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:i.relatedPosts.slice(0,3).map((e,t)=>{let i=d[e];return i?(0,s.jsx)(n.P.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6,delay:.1*t},viewport:{once:!0},children:(0,s.jsx)(a.Zp,{className:"h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1",children:(0,s.jsxs)(c(),{href:`/blog/${e}`,className:"block p-6",children:[(0,s.jsx)("div",{className:"text-4xl mb-4 text-center",children:i.image}),(0,s.jsxs)("div",{className:"flex items-center justify-between mb-4",children:[(0,s.jsx)("span",{className:"text-xs px-2 py-1 rounded-full bg-muted font-medium",children:i.category}),(0,s.jsx)("span",{className:"text-xs text-muted-foreground",children:i.readTime})]}),(0,s.jsx)("h3",{className:"font-semibold mb-3 line-clamp-2",children:i.title}),(0,s.jsx)("p",{className:"text-sm text-muted-foreground line-clamp-3",children:i.excerpt})]})})},e):null})})]})})})]})}},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},4491:(e,t,i)=>{"use strict";i.r(t),i.d(t,{GlobalError:()=>r.a,__next_app__:()=>d,pages:()=>u,routeModule:()=>m,tree:()=>c});var s=i(5239),n=i(8088),a=i(8170),r=i.n(a),o=i(893),l={};for(let e in o)0>["default","tree","pages","GlobalError","__next_app__","routeModule"].indexOf(e)&&(l[e]=()=>o[e]);i.d(t,l);let c={children:["",{children:["blog",{children:["[slug]",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(i.bind(i,9427)),"/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/blog/[slug]/page.tsx"]}]},{}]},{}]},{layout:[()=>Promise.resolve().then(i.bind(i,1137)),"/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/layout.tsx"],"not-found":[()=>Promise.resolve().then(i.t.bind(i,7398,23)),"next/dist/client/components/not-found-error"],forbidden:[()=>Promise.resolve().then(i.t.bind(i,9999,23)),"next/dist/client/components/forbidden-error"],unauthorized:[()=>Promise.resolve().then(i.t.bind(i,5284,23)),"next/dist/client/components/unauthorized-error"]}]}.children,u=["/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/blog/[slug]/page.tsx"],d={require:i,loadChunk:()=>Promise.resolve()},m=new s.AppPageRouteModule({definition:{kind:n.RouteKind.APP_PAGE,page:"/blog/[slug]/page",pathname:"/blog/[slug]",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:c}})},4493:(e,t,i)=>{"use strict";i.d(t,{Zp:()=>r});var s=i(1125),n=i(3210),a=i(4780);let r=n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("rounded-xl border bg-card text-card-foreground shadow",e),...t}));r.displayName="Card",n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("flex flex-col space-y-1.5 p-6",e),...t})).displayName="CardHeader",n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("font-semibold leading-none tracking-tight",e),...t})).displayName="CardTitle",n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("text-sm text-muted-foreground",e),...t})).displayName="CardDescription",n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("p-6 pt-0",e),...t})).displayName="CardContent",n.forwardRef(({className:e,...t},i)=>(0,s.jsx)("div",{ref:i,className:(0,a.cn)("flex items-center p-6 pt-0",e),...t})).displayName="CardFooter"},7999:(e,t,i)=>{Promise.resolve().then(i.bind(i,9427))},8247:(e,t,i)=>{Promise.resolve().then(i.bind(i,1625))},9121:e=>{"use strict";e.exports=require("next/dist/server/app-render/action-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},9427:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>s});let s=(0,i(2907).registerClientReference)(function(){throw Error("Attempted to call the default export of \"/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/blog/[slug]/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/blog/[slug]/page.tsx","default")}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),s=t.X(0,[658,161],()=>i(4491));module.exports=s})();