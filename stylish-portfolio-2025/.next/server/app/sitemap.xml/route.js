"use strict";(()=>{var e={};e.id=475,e.ids=[475],e.modules={846:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3989:(e,t,i)=>{i.r(t),i.d(t,{patchFetch:()=>b,routeModule:()=>p,serverHooks:()=>v,workAsyncStorage:()=>y,workUnitAsyncStorage:()=>f});var s={};i.r(s),i.d(s,{default:()=>h});var n={};i.r(n),i.d(n,{GET:()=>g});var a=i(2706),o=i(8203),r=i(5994),l=i(9187),u=i(8201);let c={"trans-america-racing-to-building-businesses":{id:1,title:"From Trans America Racing to Building Businesses: How Cycling Shaped My Entrepreneurial Journey",slug:"trans-america-racing-to-building-businesses",excerpt:"The mental resilience, strategic thinking, and endurance mindset developed through ultra-distance cycling became the foundation for building three successful businesses.",category:"Entrepreneurship",readTime:"8 min read",date:"2025-01-15",image:"\uD83D\uDEB4",featured:!0,author:"Martin Cox",content:`
...
*Sometimes the most sustainable businesses are built on the simplest human truths: we all want to feel connected to something meaningful.*
    `,tags:["Business Case Study","Nostalgia Marketing","Product Development","Cultural Preservation","Sustainability"],relatedPosts:["trans-america-racing-to-building-businesses","adhd-entrepreneurial-advantage","glazing-supplies-scaling"]}};function h(){let e="https://themartincox.co.uk";return[...["","/about","/portfolio","/blog","/tutoring","/contact","/adhd","/cycling","/book-call"].map(t=>({url:`${e}${t}`,lastModified:new Date,changeFrequency:"monthly",priority:""===t?1:.8})),...(0,u.OP)().map(({slug:t})=>({url:`${e}/tutoring/${t}`,lastModified:new Date,changeFrequency:"weekly",priority:.7})),...Object.keys(c).map(t=>({url:`${e}/blog/${t}`,lastModified:new Date(c[t].date),changeFrequency:"monthly",priority:.6}))]}var d=i(3192);let m={...s}.default;if("function"!=typeof m)throw Error('Default export is missing in "/Users/Martin_1/Documents/GitHub/themartincoxsite/stylish-portfolio-2025/src/app/sitemap.ts"');async function g(e,t){let{__metadata_id__:i,...s}=await t.params||{},n=!!i&&i.endsWith(".xml");if(i&&!n)return new l.NextResponse("Not Found",{status:404});let a=i&&n?i.slice(0,-4):void 0,o=await m({id:a}),r=(0,d.resolveRouteData)(o,"sitemap");return new l.NextResponse(r,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let p=new a.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?filePath=%2FUsers%2FMartin_1%2FDocuments%2FGitHub%2Fthemartincoxsite%2Fstylish-portfolio-2025%2Fsrc%2Fapp%2Fsitemap.ts&isDynamicRouteExtension=1!?__next_metadata_route__",nextConfigOutput:"",userland:n}),{workAsyncStorage:y,workUnitAsyncStorage:f,serverHooks:v}=p;function b(){return(0,r.patchFetch)({workAsyncStorage:y,workUnitAsyncStorage:f})}},8201:(e,t,i)=>{i.d(t,{OP:()=>a,k:()=>o});let s=[{name:"Nottingham",slug:"nottingham",schools:["Nottingham High School","Trent College","The Becket School"]},{name:"London",slug:"london",schools:["City of London School","Westminster School","St Paul's School"]},{name:"Surrey",slug:"surrey",schools:["Guildford High School","Charterhouse","Royal Grammar School"]},{name:"Kent",slug:"kent",schools:["Sevenoaks School","Tonbridge School","The King's School Canterbury"]},{name:"Manchester",slug:"manchester",schools:["Manchester Grammar School","Withington Girls' School"]},{name:"Reading",slug:"reading",schools:["Reading School","Abbey School","Kendrick School"]},{name:"Sheffield",slug:"sheffield",schools:["Sheffield High School","Tapton School"]},{name:"Leicester",slug:"leicester",schools:["Leicester Grammar School","Wyggeston and Queen Elizabeth I College"]},{name:"Birmingham",slug:"birmingham",schools:["King Edward VI High School","Bishop Vesey's Grammar School"]},{name:"Oxford",slug:"oxford",schools:["Magdalen College School","Oxford High School"]},{name:"Cambridge",slug:"cambridge",schools:["The Perse School","The Leys School"]},{name:"Warwick",slug:"warwick",schools:["Warwick School","King's High School"]},{name:"Durham",slug:"durham",schools:["Durham School","John Snow College"]}],n={GCSE:{title:"GCSE Business Studies",slug:"gcse-business-studies",description:"Building fundamental business knowledge and exam confidence. Focus on AQA, Edexcel, and OCR specifications.",curriculum:"AQA, Edexcel, and OCR",icon:"\uD83D\uDCDA"},"A-Level":{title:"A-Level Business Studies",slug:"a-level-business-studies",description:"Mastering complex theories, case studies, and critical analysis. Advanced preparation for university entry.",curriculum:"AQA, Edexcel, and OCR Business",icon:"\uD83C\uDF93"},Undergraduate:{title:"Business Studies Degree",slug:"business-studies-degree",description:"Support for degree-level business, management, and marketing modules. Specialized help with dissertation and critical theory.",curriculum:"University-level management and marketing",icon:"\uD83C\uDFDB️"},"Post-graduate":{title:"Masters Business Studies",slug:"masters-business-studies",description:"Specialized guidance for MBA and Masters level business studies. Strategic leadership, finance, and organizational behavior.",curriculum:"MBA and Specialized Masters",icon:"\uD83D\uDE80"}};function a(){let e=[];return Object.values(n).forEach(t=>{e.push({slug:t.slug})}),s.forEach(t=>{e.push({slug:t.slug})}),Object.values(n).forEach(t=>{s.forEach(i=>{e.push({slug:`${t.slug}-${i.slug}`})})}),e}function o(e){for(let t of Object.values(n))for(let i of s)if(e===`${t.slug}-${i.slug}`)return{level:t,location:i};for(let t of Object.values(n))if(e===t.slug)return{level:t,location:null};for(let t of s)if(e===t.slug)return{level:null,location:t};return{level:null,location:null}}}};var t=require("../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),s=t.X(0,[733,297],()=>i(3989));module.exports=s})();