...
const resources = [
  {
    ...
    items: [
      {
        name: "Driven to Distraction by Edward Hallowell",
        url: "https://www.amazon.com/Driven-Distraction-Recognizing-Attention-Childhood/dp/0307743853",
      },
      {
        name: "The ADHD Advantage by Dale Archer",
        url: "https://www.amazon.com/ADHD-Advantage-What-Thought-Disorder/dp/1583335544",
      },
      {
        name: "Smart Moves by Carla Hannaford",
        url: "https://www.amazon.com/Smart-Moves-Learning-Not-Head/dp/0915556375",
      },
      {
        name: "ADHD 2.0 by Edward Hallowell and John Ratey",
        url: "https://www.amazon.com/ADHD-2-0-Essential-Strategies-Distraction/dp/0399178732",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "Local ADHD meetup groups",
        url: "https://www.meetup.com/topics/adhd/",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "RescueTime for productivity tracking",
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Executive function coaches",
        url: "https://www.adhdcoaches.org/",
      },
      {
        name: "ADHD-friendly psychiatrists",
...
export default function AdhdContent() {
  return (
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            <h1 className="mb-8">
              ADHD: My{" "}
              <span className="italic text-creative">Entrepreneurial Edge</span>
            </h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              Discovering ADHD later in life transformed my understanding of
              myself and unlocked my entrepreneurial potential. Here's my
              journey from confusion to clarity, and how neurodiversity became
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Like many adults, my ADHD went undiagnosed for years. Here's how
              recognition and understanding changed everything about how I
              approach business and life.
            </p>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              ADHD traits that might seem challenging in traditional
              environments often become superpowers in entrepreneurship and
              business building.
            </p>
          </motion.div>
            ...
            {adhdAdvantages.map((advantage, index) => (
              ...
              >
                <Card className="p-6 h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-creative">
                    {advantage.trait}
                  </h3>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Practical strategies I've developed to harness ADHD strengths
              while managing challenges in business and daily life.
            </p>
          </motion.div>
            ...
            {managementStrategies.map((category, index) => (
              ...
              >
                <Card className="p-6 h-full">
                  <h3 className="text-xl font-semibold mb-4 text-creative">
                    {category.category}
                  </h3>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Let's address some common misconceptions about ADHD that prevent
              people from seeking help or understanding their potential.
            </p>
          </motion.div>
      ...
      <section className="section-padding bg-gradient-to-br from-creative/5 to-accent/5">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Helpful resources for anyone exploring ADHD diagnosis or looking
              to better understand and manage their neurodiversity.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {resources.map((resource, index) => (
              ...
              >
                <Card className="p-6 h-full">
                  <h3 className="text-lg font-semibold mb-4 text-creative">
                    {resource.category}
                  </h3>
                  <ul className="space-y-2">
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Whether you're exploring an ADHD diagnosis, looking to optimize
              your neurodiversity, or want to discuss how ADHD can be an
              entrepreneurial advantage, I'm here to help.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="px-8 py-4 rounded-full bg-creative hover:bg-creative/90"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-4 rounded-full border-creative text-creative hover:bg-creative hover:text-creative-foreground"
              >
                Join ADHD Community
              </Button>
            </div>
