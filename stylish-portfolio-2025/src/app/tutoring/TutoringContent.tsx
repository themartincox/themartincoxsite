...
const defaultLevels = [
  {
    level: "GCSE",
    description: "Building fundamental business knowledge and exam confidence.",
    icon: "📚",
  },
  {
    level: "A-Level",
    description:
      "Mastering complex theories, case studies, and critical analysis.",
    icon: "🎓",
  },
  {
    level: "Undergraduate",
    description:
      "Support for degree-level business, management, and marketing modules.",
    icon: "🏛️",
  },
  {
    level: "Post-graduate",
    description:
      "Specialised guidance for MBA and Masters level business studies.",
    icon: "🚀",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Yes, I offer in-person business tutoring sessions across Nottingham and surrounding areas. For those further afield or who prefer digital sessions, I provide fully remote tutoring via Zoom or Google Meet.",
  },
  {
    question: "How does your ADHD affect your tutoring style?",
    answer:
      "I leverage my 'ADHD Advantage' to create highly engaging, non-linear, and practical learning experiences. I specialise in helping neurodiverse students find learning strategies that actually work for their brains, rather than forcing traditional methods.",
  },
  {
    question:
      "Is the tutoring based on academic theory or real-world experience?",
    answer:
      "Both. I bridge the gap between academic requirements and real-world business application. Having built multiple million-pound businesses, I can explain theories using actual examples from the UK business landscape.",
  },
];
...
export default function TutoringContent({
  ...
  const schemaData = {
    ...
    description:
      level?.description ||
      `Top-rated private business studies tutoring in ${cityName} and online. Over 20 years of experience helping students succeed at GCSE, A-Level, and Degree levels. SEN friendly and neurodiverse specialist.`,
    areaServed: [
      {
        "@type": "City",
        name: cityName,
    ...
    <main className="min-h-screen pt-24 pb-16">
      ...
      <section className="container relative overflow-hidden mb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {level?.description ||
              "With over 20 years of award-winning experience, I help students navigate the complexities of the business syllabus with confidence."}
            <br className="hidden md:block" />
            Personalised support{" "}
            {level
              ? `focused on ${level.title}`
              : "from GCSE to Post-graduate levels"}
            ,
            {location
              ? ` serving students across ${location.name}`
              : " available in-person in Nottingham"}{" "}
            or online worldwide.
            <br />
            <span className="text-sm font-medium text-accent mt-4 inline-block italic">
              SEN Friendly & Neurodiverse Specialist
            </span>
          </motion.p>
          <motion.div
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {defaultLevels.map((lvl, index) => (
              ...
              >
                <Card
                  className={`p-8 h-full flex flex-col items-center text-center hover:border-accent transition-colors duration-300 ${level?.title.includes(lvl.level) ? "border-accent bg-accent/5" : ""}`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                I'm Martin, and my mission is to help students unlock their full
                potential through education that is relatable, engaging, and
                grounded in real-world application.
              </p>
              <div className="space-y-6 mb-8 text-muted-foreground">
                <p>
                  With an award-winning background in University-level teaching,
                  I've supported thousands of students in achieving the grades
                  they deserve—whether helping them master complex coursework or
                  excel in final exams.
                </p>
                <p>
                  As an Academic Advisory Board Member for the American
                  Institute of Business & Management, I consult on course design
                  at the highest levels. My global perspective is shaped by
                  teaching students across the UK and internationally, from
                  London to Hong Kong and Dubai.
                </p>
              </div>
            ...
            >
              <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-accent/20 to-secondary/20 flex items-center justify-center relative">
                <div className="text-[12rem] filter grayscale opacity-20">
                  📈
                </div>
                <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center bg-background/40 backdrop-blur-sm">
                  <h3 className="text-2xl font-bold mb-4">
                    "Making sense of the business syllabus"
                  </h3>
                  <p className="italic">
                    Relatable, responsive, and outcomes-focused tutoring.
                  </p>
                </div>
              </div>
              <div className="absolute -bottom-6 -right-6 bg-card border p-6 rounded-2xl shadow-xl max-w-xs">
                <p className="text-sm font-medium leading-relaxed">
                  "One of our best tutors. Quality profile, verified
                  qualifications, and a great response time."
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="section-padding border-b bg-muted/20">
          <div className="container max-w-4xl text-center">
            <h2 className="mb-8 font-display">
              Supporting Students in {location.name}
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Providing specialist business studies support for students
              throughout {location.name}.
              {location.schools && location.schools.length > 0 && (
                <>
                  {" "}
                  Including those attending{" "}
                  <strong>{location.schools.join(", ")}</strong> and other
                  leading local institutions.
                </>
              )}
            </p>
            <div className="flex justify-center gap-4">
              <div className="px-6 py-3 rounded-full bg-accent/10 border border-accent/20 text-accent font-medium text-sm">
                Local In-Person
              </div>
              <div className="px-6 py-3 rounded-full bg-secondary/10 border border-secondary/20 text-secondary font-medium text-sm">
                Online Sessions
              </div>
            </div>
            <p className="mt-8 text-sm text-muted-foreground italic">
              Available for home visits or sessions in public spaces within 10km
              of {location.name}.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-2xl bg-muted/30 border border-transparent hover:border-accent/20 transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Personalised support for GCSE, A-levels, T-levels, and
                    BTECs. I also specialise in entrance exam preparation for
                    prestigious institutions like Bromsgrove and Gordon's.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-muted/30 border border-transparent hover:border-accent/20 transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    I support Undergraduates and Post-graduates at Russell Group
                    universities, as well as students on programs at Oxford,
                    Harvard, and various MBA pathways.
                  </p>
                </div>
              </div>
              <div className="space-y-6">
                <div className="p-6 rounded-2xl bg-accent/5 border border-accent/10">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Business isn't just about textbooks. I bring the curriculum
                    to life by relating every concept to real-world scenarios,
                    ensuring students don't just learn—they understand.
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-secondary/5 border border-secondary/10">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Every student has a unique learning style. My sessions are
                    designed to engage and connect, providing incisive support
                    that delivers both results and confidence.
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-12 text-center p-8 rounded-3xl bg-secondary/10 border border-secondary/20">
              <p className="text-lg font-medium italic">
                "I help students of all levels make sense of the curriculum,
                turning classroom challenges into opportunities for growth."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="mb-6">
                The <span className="text-creative">Neurodiverse</span>{" "}
                Advantage
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                As an adult-diagnosed entrepreneur with ADHD, I don't just teach
                business; I teach how to navigate business with a neurodiverse
                brain.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-creative/5 border border-creative/10">
                  ...
                  <div>
                    <h4 className="font-bold text-creative">
                      Adaptive Learning
                    </h4>
                    <p className="text-sm text-muted-foreground">
                      Moving beyond textbooks to find the learning style that
                      fits your cognitive profile.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 rounded-xl bg-accent/5 border border-accent/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Turning ADHD traits into intense productivity and deep
                      subject mastery.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-12 max-w-3xl mx-auto p-6 bg-accent/5 rounded-2xl border border-accent/10 text-center italic">
            "I have had notable success supporting neurodiverse learners and
            those who find traditional classroom settings challenging. Being
            ADHD myself, I truly understand the hurdles students face."
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="mt-16 p-8 bg-accent/10 rounded-3xl border border-accent/20 text-center">
            <p className="font-medium text-lg mb-4 italic">
              "Martin's sessions are the best! High quality education, expert
              knowledge, and a respectful, fun atmosphere."
            </p>
      ...
      <section id="locations" className="section-padding border-t bg-muted/20">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center text-pretty">
            Tutor Services by Location
          </h2>
          ...
          <div className="mt-20 pt-10 border-t">
            <h2 className="text-3xl font-bold mb-8 text-center">
              Business Studies Support Levels
            </h2>
      ...
      <section className="section-padding">
        <div className="container text-center max-w-3xl">
          ...
          <p className="text-xl text-muted-foreground mb-10">
            Whether you're struggling with concepts or aiming for top grades,
            let's build your path to success in {cityName}.
          </p>
