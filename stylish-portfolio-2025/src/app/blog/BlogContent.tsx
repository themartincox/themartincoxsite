...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "My journey from confusion to clarity - getting diagnosed with ADHD as an adult and how it transformed my self-understanding.",
    category: "ADHD",
    readTime: "7 min read",
    date: "2024-12-28",
    image: "💡",
  ...
  },
  {
    ...
    excerpt:
      "What 4,200km across America teaches you about pushing through barriers, both on the bike and in business.",
    category: "Cycling",
    readTime: "6 min read",
    date: "2024-12-20",
    image: "🏔️",
  ...
  },
  {
    ...
    excerpt:
      "Practical marketing insights from helping dozens of UK small businesses grow through Postino consultancy.",
    category: "Marketing",
    readTime: "8 min read",
    date: "2024-12-15",
    image: "📊",
  ...
  },
  {
    ...
    excerpt:
      "How to harness the ADHD superpower of hyperfocus for maximum productivity and creative output in business.",
    category: "ADHD",
    readTime: "5 min read",
    date: "2024-12-10",
    image: "🎯",
  ...
  },
  {
    ...
    excerpt:
      "The strategic decisions and tactical moves that took a traditional manufacturing business to new heights.",
    category: "Business Case Study",
    readTime: "7 min read",
    date: "2024-12-05",
    image: "🏭",
  ...
  },
  {
    ...
    excerpt:
      "The parallels between preparing for an ultra-distance race and planning a business strategy.",
    category: "Strategy",
    readTime: "6 min read",
    date: "2024-11-28",
    image: "🗺️",
  ...
  },
  {
    ...
    excerpt:
      "Practical strategies for thriving in business when your brain works differently from the norm.",
    category: "ADHD",
    readTime: "5 min read",
    date: "2024-11-20",
    image: "⚙️",
  ...
  },
  {
    ...
    excerpt:
      "How to successfully manage multiple ventures without burning out, using lessons from endurance sports.",
    category: "Entrepreneurship",
    readTime: "7 min read",
    date: "2024-11-15",
    image: "🏗️",
  ...
  },
  {
    ...
    excerpt:
      "Why traditional business advice doesn't always work for ADHD entrepreneurs and what does instead.",
    category: "ADHD",
    readTime: "8 min read",
    date: "2024-11-10",
    image: "🌟",
    ...
    <main className="min-h-screen pt-24">
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            <h1 className="mb-8">
              Insights & <span className="italic text-accent">Stories</span>
            </h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              Sharing lessons learned from ultra-distance cycling, building
              businesses, and navigating life with ADHD. Real experiences,
              practical insights, and honest reflections from the journey.
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Latest insights from the journey
              </p>
            </div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore insights on entrepreneurship, ADHD, cycling, and business
              building
            </p>
          </motion.div>
                          ...
                          post.category === "ADHD"
                            ...
                            : post.category === "Entrepreneurship"
                              ...
                              : post.category === "Cycling"
                                ? "text-success"
                                : post.category === "Business Case Study"
                                  ? "text-accent"
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Get the latest insights on entrepreneurship, ADHD advantages,
              cycling lessons, and business building delivered to your inbox.
            </p>
            ...
            {[
              {
                name: "ADHD Insights",
                icon: "🧠",
                desc: "Neurodiversity as advantage",
                color: "from-creative/20 to-creative/5",
              },
              {
                name: "Business Building",
                icon: "🏗️",
                desc: "Entrepreneurial lessons",
                color: "from-secondary/20 to-secondary/5",
              },
              {
                name: "Cycling Stories",
                icon: "🚴",
                desc: "Ultra-distance adventures",
                color: "from-success/20 to-success/5",
              },
              {
                name: "Growth Strategy",
                icon: "📈",
                desc: "Marketing & scaling",
              ...
              >
                <Card
                  className={`p-6 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-1 cursor-pointer bg-gradient-to-br ${topic.color}`}
                >
