...
const myFirms = [
  {
    ...
    period: "2018 - Present",
    description:
      "Building a consultancy that helps UK SMEs navigate growth challenges with data-driven marketing and strategic positioning.",
  ...
  },
  {
    ...
    period: "1993 - Present",
    description:
      "Reviving nostalgic products with modern sustainability focus. From childhood memory to thriving business spanning three decades.",
  ...
  },
  {
    ...
    period: "2015 - Present",
    description:
      "UK-made glazing solutions serving 8,000+ professionals. Building trust in a traditional industry through quality and reliability.",
...
const clientWork = [
  {
    ...
    challenge:
      "Brand positioning and digital presence for specialist vacuum equipment",
    solution:
      "Developed technical content strategy and B2B marketing framework",
  ...
  },
  {
    ...
    solution:
      "Go-to-market strategy, competitor analysis, and positioning framework",
  ...
  },
  {
    ...
    challenge:
      "Business development and growth strategy for boutique creative agency",
  ...
  },
  {
    ...
    challenge:
      "Digital transformation and process automation for established PR firm",
  ...
  },
  {
    ...
    challenge:
      "Digital modernisation and lead generation for traditional manufacturer",
  ...
  },
  {
    ...
    challenge:
      "E-commerce growth and brand positioning for artisan pizza ovens",
...
const learningsFromFailures = [
  {
    ...
    period: "2016-2017",
    challenge:
      "Ambitious consulting platform attempting to democratise business advice",
    whatWentWrong: [
    ...
    howItMadeMeBetter:
      "Now I validate every assumption before building. Led to Postino's focused, proven approach.",
  ...
  },
  {
    ...
    period: "2017-2018",
    challenge:
      "Cycling training platform combining performance data with coaching",
    whatWentWrong: [
    ...
    howItMadeMeBetter:
      "Developed rigorous validation processes. Now use lean methodology for all new ventures.",
...
const coreStrengths = [
  {
    ...
    description:
      "Every failure becomes data. Every success gets systematised. Continuous improvement isn't just business practice—it's personal philosophy.",
    icon: "📈",
  },
  {
    strength: "Results-Driven Approach",
    description:
      "Metrics matter. Whether it's 180% lead growth or £0-£10k/week revenue, I focus on outcomes that move the business forward.",
    icon: "🎯",
  },
  {
    strength: "Cross-Industry Experience",
    description:
      "From MedTech to Manufacturing, Financial Services to Creative Agencies. Pattern recognition across sectors reveals universal growth principles.",
    icon: "🔄",
  },
  {
    strength: "ADHD-Powered Problem Solving",
    description:
      "Hyperfocus meets pattern recognition. Complex business challenges become puzzles to solve, often revealing unconventional solutions.",
    icon: "🧠",
  },
];
    ...
    <main className="min-h-screen pt-24">
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            <h1 className="mb-8">
              Business Portfolio &{" "}
              <span className="italic text-accent">Learnings</span>
            </h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              Three decades of building businesses, serving clients, and
              learning from both spectacular successes and valuable failures.
              Here's the authentic story of growth, results, and why experience
              matters in business strategy.
            </p>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Three distinct ventures, each born from different motivations and
              teaching unique lessons about entrepreneurship, persistence, and
          ...
          <div className="space-y-12 max-w-6xl mx-auto">
            {myFirms.map((firm, index) => (
              ...
              >
                <Card
                  className={`overflow-hidden ${firm.featured ? "border-accent/30" : ""}`}
                >
                  <div
                    className={`p-8 md:p-12 bg-gradient-to-br ${firm.color} relative`}
                  >
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                        <h4 className="font-semibold mb-4 text-creative">
                          Lessons Learned
                        </h4>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              From industrial equipment to creative agencies, each client
              brought unique challenges and opportunities for growth. Here's how
              we delivered results together.
            </p>
          </motion.div>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container">
          ...
          >
            <h2 className="mb-6">
              Learning from <span className="text-red-500">Failures</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Not everything succeeded. Here are two ventures that didn't work
              out as planned, what went wrong, and how these experiences made me
              a better entrepreneur and consultant.
            </p>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Three decades of building, failing, learning, and succeeding have
              crystallised into these core strengths that I bring to every
              client engagement.
            </p>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto text-pretty">
              Three decades of experience, honest about failures, obsessed with
              results. Let's discuss how these hard-won insights can accelerate
              your growth.
            </p>
