        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              Whether you have a specific project in mind, need creative
              guidance, or just want to explore possibilities, I'd love to hear
              from you. Every great collaboration begins with a simple
              conversation.
            </p>
          </motion.div>
              ...
              <Card className="p-8 bg-gradient-to-br from-card to-card/50 border-0 shadow-lg">
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    I'll review your message and respond within 24 hours with
                    next steps.
                  </p>
                </form>
              </Card>
            ...
            >
                ...
                <Card className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    <p className="text-xs text-muted-foreground">
                      For urgent projects outside office hours, please call or
                ...
                <Card className="p-6">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Available for local meetings and consultations throughout
                      the East Midlands
                    </div>
                  </div>
                </Card>
              ...
              <div>
                ...
                <Card className="p-6 bg-accent/5 border-accent/20">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    I offer expedited services for time-sensitive projects with
                    rush timelines.
                  </p>
                  <Button
                    variant="outline"
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty">
              Not ready to fill out a form? No problem. Here are other ways we
              can connect and talk through your consultancy or tutoring needs.
            </p>
