...
const equipmentSpecs = [
  ...
  {
    item: "Nutrition",
    spec: "Carefully calculated calorie and electrolyte strategy",
  },
...
export default function CyclingContent() {
  return (
      ...
      <section className="section-padding">
        <div className="container">
          ...
          >
            <h1 className="mb-8">
              Ultra-Distance{" "}
              <span className="italic text-success">Cycling Journey</span>
            </h1>
            <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
              From weekend warrior to competing in the world's toughest
              ultra-distance races. Discover how cycling across continents
              shaped my approach to business, mental resilience, and achieving
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto mb-20">
            {raceAchievements.map((race, index) => (
              ...
              >
                <Card
                  className={`p-8 h-full ${race.highlight ? "border-success bg-success/5" : ""} hover:shadow-lg transition-all duration-300`}
                >
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <div
                        className={`text-sm font-bold px-3 py-1 rounded-full mb-3 ${
                          race.highlight
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Every mile ridden, every mountain climbed, every mental barrier
              broken taught lessons that directly translate to building and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Success in ultra-distance racing comes down to meticulous
                preparation, equipment optimization, and strategic thinking -
            ...
            >
              ...
              <Card className="p-6 mt-8 bg-gradient-to-br from-success/10 to-accent/5">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  While my competitive racing days are focused on business
                  building, I still ride regularly for fitness, mental clarity,
                  and the pure joy of being on two wheels. The lessons learned
                  continue to fuel my entrepreneurial journey.
                </p>
              </Card>
            </motion.div>
          </div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 text-pretty">
              Ultra-distance cycling introduced me to an incredible community of
              athletes, dreamers, and achievers. The friendships forged on long
              rides and at finish lines have enriched both my personal life and
              business network.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="px-8 py-4 rounded-full bg-success hover:bg-success/90"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-4 rounded-full border-success text-success hover:bg-success hover:text-success-foreground"
              >
